...
class ExternalConversationIngestRequest(BaseModel):
    """Import conversation turns from any external chat system into Ordo history."""
    ...
    conversation_id: UUID | None = Field(default=None, description="Append to an existing Ordo conversation")
