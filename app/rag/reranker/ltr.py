...
_FEATURE_SPEC_FINGERPRINT_SCHEMA_V1 = "ordo.ltr_feature_spec.v1"
...
class LTRFeatureSpec:
    ...
    def v2() -> "LTRFeatureSpec":
        ...
        return LTRFeatureSpec(schema="ordo.ltr_features.v2", feature_names=tuple(base))
    ...
    def v3() -> "LTRFeatureSpec":
        ...
        return LTRFeatureSpec(schema="ordo.ltr_features.v3", feature_names=tuple(base))
