...
FIXTURES: dict[str, StrategyFixture] = {
    "generic_text": _fixture(
        "generic.txt",
        """
        Ordo runs retrieval, governance, and chunking for multi-format corpora.
    ...
    for strategy in sorted(
        ...
        try:
            if strategy in chunker_factory.INTEGRATED_PIPELINE_STRATEGIES:
                with tempfile.TemporaryDirectory(prefix="ordo-strategy-matrix-") as tmpdir:
