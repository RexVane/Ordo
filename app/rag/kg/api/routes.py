...
def import_manual_kg(
    ...
    *,
    ...
    """
    Import a manually governed KG payload into Ordo.

    Domain-specific extraction/rule building should happen outside Ordo and
...
def _kg_graph_export_content(
    *, payload: str, flags: KGGraphExportFlags, tenant_id: UUID
    ...
    if flags.download:
        ...
        headers["Content-Disposition"] = f'attachment; filename="ordo-kg-{tenant_id}.{ext}"'
