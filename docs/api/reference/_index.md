...
| 文件 | 标题 |
| --- | --- |
| [`000-title.md`](./000-title.md) | Ordo API 接口文档 |
...
- [Docusaurus 手册（GitHub Pages）](https://example.com/handbook/)
- [OpenAPI / Redoc](https://example.com/handbook/)

### 联调与业务剧本

- [集成总览](https://example.com/handbook/docs/integration/welcome)
- [业务剧本：新租户首日上线](https://example.com/handbook/docs/integration/tasks/go-live-tenant)
- [业务剧本：知识库可对用户问答](https://example.com/handbook/docs/integration/tasks/knowledge-base-qa)
- [业务剧本：文档卡在解析或索引](https://example.com/handbook/docs/integration/tasks/document-stuck)
