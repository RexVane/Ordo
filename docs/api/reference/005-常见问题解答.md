...
> **联调视角**：现象与止损可与手册 [文档卡住](https://example.com/handbook/docs/integration/tasks/document-stuck)、[可对用户问答](https://example.com/handbook/docs/integration/tasks/knowledge-base-qa) 对照；总入口 [集成总览](https://example.com/handbook/docs/integration/welcome)。
