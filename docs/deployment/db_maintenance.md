...
- `deploy/helm/ordo/templates/cronjob-db-maintenance.yaml`
- `deploy/helm/ordo/templates/cronjob-semantic-cache-retention.yaml`

values 配置入口：

- `deploy/helm/ordo/values.yaml` → `cronjobs.dbMaintenance`
- `deploy/helm/ordo/values.yaml` → `cronjobs.semanticCacheRetention`
