...
> **SSOT 提示**：接口字段以 OpenAPI（`web/openapi.json`）与 [在线 Redoc](https://example.com/handbook/) 为准。以下为导航入口；长篇叙述已按一级标题拆分为多文件。

## 在线资源

| 资源 | 链接 |
| --- | --- |
| 全栈手册（Docusaurus，可搜索） | [https://example.com/handbook/](https://example.com/handbook/) |
| 全量 OpenAPI / Redoc | [https://example.com/handbook/](https://example.com/handbook/) |
