...
def test_collect_trace_report_counts_ordo_http_conversion_code_results() -> None:
    mod = _load_module()
                            ...
                            "result": [
                                {
                                    ...
                                    "metadata": {"retriever_from": "ordo_http"},
                                }
                            ]
                        },
                    },
                    {
                        "title": "安全构造 Ordo 检索请求 - 新北区政务服务",
                        "node_type": "code",
