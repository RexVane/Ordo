...
def _metadata_schema() -> dict:
    return {
        "schema": "ordo.metadata_schema.v1",
        "fields": [
            {
                "name": "topic",
                "type": "string",
...
def test_summarize_contracts_preserves_retrieval_policy_summary_behavior() -> None:
    summary = summarize_contracts(
        ...
        retrieval_text_schema={"schema": "ordo.retrieval_text_schema.v1", "stages": {"chunk": {}, "governance": {}}},
        golden_rules={"schema": "ordo.golden_rules.v1"},
        retrieval_policy={
    ...
    assert summary["golden"] == {"schema": "ordo.golden_rules.v1", "enabled": True}
...
def test_validate_retrieval_text_schema_metadata_fields_accepts_content_only_entries() -> None:
    validate_retrieval_text_schema_metadata_fields(
        retrieval_text_schema={
            "schema": "ordo.retrieval_text_schema.v1",
            "stages": {
                "chunk": {
                    "fields": [
