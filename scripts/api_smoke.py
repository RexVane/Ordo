...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Smoke-test Ordo API endpoints.")
    ...
    parser.add_argument(
        ...
        "--jwt-email",
        dest="jwt_identifier",
        default=os.getenv("ORDO_SMOKE_IDENTIFIER") or os.getenv("ORDO_SMOKE_JWT_EMAIL") or "",
    )
    parser.add_argument(
        "--jwt-password",
        default=os.getenv("ORDO_SMOKE_PASSWORD") or os.getenv("ORDO_SMOKE_JWT_PASSWORD") or "",
    )
