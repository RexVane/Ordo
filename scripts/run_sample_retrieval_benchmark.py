...
_FIXTURE_SCHEMA = "ordo.sample_retrieval_fixture.v1"
_REPORT_SCHEMA = "ordo.sample_retrieval_benchmark.v1"
...
def _uuid_from_seed(seed: str) -> uuid.UUID:
    return uuid.uuid5(uuid.NAMESPACE_URL, f"ordo/sample-bench/{seed}")
