...
export ORDO_DB_CREATE_ALL_ON_STARTUP="${ORDO_DB_CREATE_ALL_ON_STARTUP:-false}"
export ORDO_DB_RUNTIME_MIGRATIONS_ENABLED="${ORDO_DB_RUNTIME_MIGRATIONS_ENABLED:-false}"
