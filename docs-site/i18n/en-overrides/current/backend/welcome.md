...
This handbook is for **backend developers, architects, and integration engineers**, helping you quickly understand Ordo backend's module boundaries, API contracts, and internal flows. Use [OpenAPI / Redoc](https://example.com/handbook/) as the authoritative Schema reference; this handbook focuses on **navigation indexes, state-machine descriptions, and troubleshooting guides**.
