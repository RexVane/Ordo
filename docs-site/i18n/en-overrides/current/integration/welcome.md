...
This section starts from **"How to integrate Ordo into your environment"** and complements the Frontend / Backend / Ops documentation: those cover pages and implementation details, while this section focuses on **business outcomes, recommended paths, and contract entry points**.
...
- **Human & machine-readable contracts**: [API_CONTRACT](https://example.com/OWNER/REPO/blob/main/docs/integration/API_CONTRACT.md) | [FE/BE Debugging](https://example.com/OWNER/REPO/blob/main/docs/integration/FE_BE_DEBUG.md)
- **Full Schema / try calls**: [OpenAPI / Redoc](https://example.com/handbook/)
...
Ordo supports three authentication methods, in order of priority:
...
| Type | Link |
| --- | --- |
| Redoc | [Redoc](https://example.com/handbook/) |
| Scenario-based API Sequences | [workflows.md](https://example.com/OWNER/REPO/blob/main/docs/api/workflows.md) |
| Contracts & Debugging | [API_CONTRACT](https://example.com/OWNER/REPO/blob/main/docs/integration/API_CONTRACT.md) | [FE_BE_DEBUG](https://example.com/OWNER/REPO/blob/main/docs/integration/FE_BE_DEBUG.md) |
