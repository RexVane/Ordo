...
const OPEN_SECTIONS_STORAGE_KEY = 'ordo_navbar_open_sections_v2'
...
export function Navbar({
  ...
  useEffect(() => {
    ...
    const key = '__ordo_routes_prefetched__'
  ...
  return (
    <>
      ...
      >
        ...
        <div
          data-sidebar-header
          className="h-14 px-5 border-b border-info/12 bg-sidebar/96 flex items-center gap-3"
        >
          <Link href="/" className="flex items-center gap-3 group rounded-xl focus-ring">
            ...
            <div className="flex flex-col">
              <span className="font-bold text-sidebar-foreground leading-none">Ordo</span>
          ...
          <Button
            ...
            variant="ghost"
            size="icon"
            className="ml-auto size-9 rounded-xl text-muted-foreground hover:bg-info/7 hover:text-info"
            aria-controls="ordo-sidebar"
            aria-expanded={true}
        ...
        <div className="px-3 pb-2">
          <button
            ...
            aria-controls="ordo-command-menu"
    ...
    if (backendOk === true) {
      ...
      {/* Reopen control remains available after the sidebar has been collapsed. */}
      {!isSidebarOpen ? (
          ...
          <div className="relative h-full w-full overflow-visible">
            <Button
              ...
              className={cn(
                ...
                'left-3 top-4 size-9 rounded-full pointer-events-auto md:left-2 md:top-1/2 md:-translate-y-1/2 supports-[padding:env(safe-area-inset-left)]:md:left-[calc(env(safe-area-inset-left)+0.5rem)]'
              )}
              onPointerDown={handleSidebarTogglePointerDown}
              onKeyDown={handleSidebarToggleKeyDown}
              onClick={handleSidebarToggle}
