...
const PAGE_ALL_VALUE = '__ordo_page_all__'
const PAGE_UNKNOWN_VALUE = '__ordo_page_unknown__'
const SECTION_ALL_VALUE = '__ordo_section_all__'
const SECTION_NONE_VALUE = '__ordo_section_none__'
