...
import { Send, StopCircle, Sparkles, Database, Wand2, Settings2, Mic, ArrowDown, Route, Palette, ChevronDown } from 'lucide-react'
...
const SELECT_DEFAULT_VALUE = '__ordo_default__'
  ...
  return (
    <div className="mx-auto flex min-h-full w-full max-w-5xl flex-col items-center px-4 pb-8 pt-32 md:px-8 md:pt-48">
      <div className="flex animate-fade-in-up flex-col items-center space-y-4 text-center">
        ...
        />
        <div>
          <h1 className="text-3xl font-semibold tracking-[-0.04em] text-foreground sm:text-4xl">Ordo</h1>
