...
export const SURFACE_THEME_STORAGE_KEY = 'ordo.surfaceTheme'
export const THEME_COLOR_STORAGE_KEY = 'ordo.themeColor'
export const SURFACE_THEME_COOKIE_KEY = 'ordo_surface_theme'
export const THEME_COLOR_COOKIE_KEY = 'ordo_theme_color'
export const THEME_APPEARANCE_CHANGED_EVENT = 'ordo:theme-appearance-changed'
